...
function getHoursWorked(){
  while (keepGoing){
    hours=prompt("Enter the hours worked in a week for employee " + employeeNumber + " (Enter a negative number to end)");
...
function generateOutputString(){
    outputString = "<table border=1><th>Employee</th><th>Hours Worked</th><th>Salary</th>";
  var weekIncome = 0;
